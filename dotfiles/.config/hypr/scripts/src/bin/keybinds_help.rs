...
const KEYBIND_CATEGORIES: &[KeybindCategory] = &[
    KeybindCategory {
        ...
        keybinds: &[
            ...
            ("Cycle through layouts", "SUPER + TAB"),
            ...
            ("Move window right", "SUPER + ALT + RIGHT"),
            ("Move window up", "SUPER + ALT + UP"),
            ("Move window down", "SUPER + ALT + DOWN"),
            ("Move window with mouse drag", "SUPER + Left Mouse"),
            ("Resize window with mouse drag", "SUPER + Right Mouse"),
            ...
            ("Switch to grid layout", "SUPER + G"),
            ("Toggle dwindle split", "SUPER + J"),
            ("Toggle cursor zoom", "SUPER + Z"),
            ("Zoom in", "SUPER + KP_ADD"),
            ("Zoom out", "SUPER + minus"),
            ("Toggle game mode", "SUPER + F1"),
    ...
    KeybindCategory {
        ...
        keybinds: &[
            ...
            ("Open secondary terminal", "SUPER + Return"),
            ("Open floating mini terminal", "SUPER + SHIFT + Q"),
            ("Open file manager", "SUPER + E"),
            ("Open browser", "SUPER + ALT + B"),
            ("Open code editor", "SUPER + ALT + V"),
            ("Open app entries manager", "SUPER + A"),
            ("Open emoji picker", "SUPER + ALT + E"),
            ("Open clipboard manager", "SUPER + SHIFT + V"),
            ("Start screenrecorder", "SUPER + ALT + R"),
            ("Toggle music bar (hyprwave)", "SUPER + P"),
            ("Music bar previous track", "SUPER + P + LEFT"),
            ("Music bar next track", "SUPER + P + RIGHT"),
        ],
    },
    KeybindCategory {
        ...
        keybinds: &[
            ...
            ("Open waybar flavour switcher", "SUPER + CTRL + W"),
            ("Open wallpaper switcher (theme)", "SUPER + SHIFT + T"),
            ("Open wallpaper switcher (global)", "SUPER + SHIFT + I"),
            ("Open starship config switcher", "SUPER + SHIFT + A"),
            ("Open rofi config switcher", "SUPER + SHIFT + R"),
            ("Open system menu", "SUPER + SHIFT + M"),
        ],
    },
    KeybindCategory {
